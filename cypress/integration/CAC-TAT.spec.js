...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it("preenche os campos obrigatórios e envia o formulário", function(){
        const longtext = "teste, teste ,testeteste, teste ,testeteste, teste ,testeteste, teste ,testeteste, teste ,testeteste, teste ,testeteste, teste ,testeteste, teste ,teste"
    ...
    it("exibe mensagem de erro ao submeter o formulário com um e-mail inválido", function(){
        ...
        cy.get('#firstName').type("Gabriel")
        cy.get('#lastName').type("Zanetti")
        cy.get('#email').type("emailemail.com.br")
